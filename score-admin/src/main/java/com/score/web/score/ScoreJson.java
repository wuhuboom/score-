...
public class ScoreJson {
    ...
    @JSONField(name="hasLineup")
    private Integer has_lineup;

    @JSONField(name="inplayCreatedAt")
    private Date inplay_created_at;

    @JSONField(name="inplayUpdatedAt")
    private Date inplay_updated_at;

    @JSONField(name="confirmedAt")
    private Date confirmed_at;

    @JSONField(name="bet365Id")
